...
const Header = (props) => {
    const { backIcon,
        ...
        props;
    return (
        <View style={{ backgroundColor: "#1D6DFD", height: height * 0.14, width: width * 1 }}>
            <ImageBackground resizeMode="stretch" source={ImagePath.HEADERBACK} style={{ paddingTop: 20, flexDirection: "row", height: height * 0.21, width: "100%" }}>
                <View style={{
                    marginTop: height * 0.02,
                    // backgroundColor: "#1D6DFD",
                    height: height * 0.08, width: width * 1, flexDirection: "row"
                }}>
                    {backIcon ?
                        <View style={{
                            ...
                            : cross ?
                                <View style={{
                                    ...
                                    <TouchableOpacity onPress={onCrossPress}>
                                        <Image source={ImagePath.CROSSHEAD} resizeMode="contain" style={{ height: 30, width: 30 }} />
                                    </TouchableOpacity>
                                </View> : null
                    }
                    {HeaderTitle ?
                        <View style={{
                            ...
                            <View style={{
                                ...
                                justifyContent: "center", alignItems: "center", height: height * 0.08, width: width * 0.61
                            }}>
                                <Text style={{ fontFamily: FONTS.PoppinsMedium, color: "#FFFFFF", fontSize: height / 48 }}>{Title}</Text>
                            </View>
                        </View> : null}
                    {rightIcon ?
                        <View style={{

...
const NewHeader = (props) => {
    const { backIcon,
        ...
        props;
    return (
        <View style={{ backgroundColor: "#1D6DFD", height: height * 0.1, width: width * 1 }}>
            <ImageBackground resizeMode="stretch" source={require("../../assets/Images/Header/NewHeader.png")} style={{ paddingTop: 20, flexDirection: "row", height: height * 0.15, width: width * 1 }}>
                {backIcon ?
                    <View style={{
